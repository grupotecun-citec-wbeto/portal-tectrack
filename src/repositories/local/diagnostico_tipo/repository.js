/**
 * @package repositories/local/diagnostico_tipo
 * @description Repositorio de la tabla de diagnostico_tipo
 * @author CITEC
 */

const PACKAGE = 'repositories/local/diagnostico_tipo';

import { getDB, persistDatabase } from '../../../db/database';

const repository = {
    tableCode:13,
    tableName:'diagnostico_tipo',
    /**
     * 
