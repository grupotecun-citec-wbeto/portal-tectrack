/**
 * @package repositories/local/caso_estado
 * @description Repositorio de la tabla de caso_estado
 * @author CITEC
 */

const PACKAGE = 'repositories/local/caso_estado';

import { getDB, persistDatabase } from '../../../db/database';

const repository = {
    tableCode:5,
    tableName:'caso_estado',
    /**
     * 
