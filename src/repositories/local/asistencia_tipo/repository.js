/**
 * @package repositories/local/asistencia_tipo
 * @description Repositorio de la tabla de asistencia_tipo
 * @author CITEC
 */

const PACKAGE = 'repositories/local/asistencia_tipo';

import { getDB, persistDatabase } from '../../../db/database';

const repository = {
    tableCode:3,
    tableName:'asistencia_tipo',
    /**
     * 
