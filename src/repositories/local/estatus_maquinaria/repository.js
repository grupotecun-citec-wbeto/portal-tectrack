/**
 * @package repositories/local/estatus_maquinaria
 * @description Repositorio de la tabla de estatus_maquinaria
 * @author CITEC
 */

const PACKAGE = 'repositories/local/estatus_maquinaria';

import { getDB, persistDatabase } from '../../../db/database';

const repository = {
    tableCode:18,
    tableName:'estatus_maquinaria',
    /**
     * 
