  ...
  return (
    <Box mb={4}>
      ...
      <Modal
        ...
        scrollBehavior={isMobile ? 'inside' : 'inside'}
        isCentered={!isMobile}
      >
        <ModalOverlay />
        <ModalContent
        ...
        >
          ...
          <ModalBody
            ...
            flex="1"
            p={isMobile ? 0 : 4}
            overflowY="hidden" // Prevent double scrollbars, let ReactQuill handle scrolling
          >
            <div
              className="notranslate"
              translate="no"
            ...
            >
              ...
              <style>{`
                ...
                .quill-mobile-fix .ql-editor {
                  flex: 1;
                  overflow-y: auto;
                  font-size: 16px;
                  background-color: #ffffff;
                }
                .quill-mobile-fix .ql-editor.ql-blank::before {
                  color: #a0aec0;
                  font-style: italic;
                }
              `}</style>
