...
function CardEspecialista(props) {
  ...
  return (
    <Card>
      <CardHeader>
        <Heading as="h2" fontSize={{ base: "md", md: "lg" }} fontWeight="semibold">¿Necesitas incluir a Especialista?</Heading>
      </CardHeader>
      <CardBody mt='20px'>
          ...
          {necesitaEspecialista && (
            <Flex ms={{ xl: '25px', sm: '25px' }}>
              <FormControl maxW={{ xl: '250px' }}>
                <FormLabel htmlFor='country' fontSize={{ base: "sm", md: "md" }}>Especialista</FormLabel>
                <Select id='country' placeholder='Seleccionar a especialista' onChange={(e) => actionSelectEspecialista(e.target.value)} value={selectedEspecialista} fontSize={{ base: "sm", md: "md" }}>
