...
function SelectSegmentoDash({ onSearch }) {
  ...
  return (
    <Flex direction='column' pt={{ base: "120px", md: "75px", lg: "100px" }}>
      <Grid templateColumns={{ base: "1fr", md: "repeat(2, 1fr)" }} gap='22px'>

        <CardSelectCaso
          title="Soporte"
          description="Gestión y seguimiento de casos de soporte técnico."
          to=""
          id='1'
        ...
        <CardSelectCaso
          title="Proyecto"
          description="Administración y control de proyectos en curso."
          to=""
          id='2'
          btnCreateCase={btnCreateCase}
        />
        <CardSelectCaso
          title="Capacitación"
          description="Programas de formación y desarrollo de habilidades."
          to=""
          id='3'
          btnCreateCase={btnCreateCase}
        />
