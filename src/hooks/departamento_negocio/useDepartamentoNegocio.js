 ...
 * @description Hook para manejar la sincronización de departamento_negocio
 * @author CITEC
 */
...
// servicios
import syncService from '../../services/departamento_negocio/syncService';


function useDepartamentoNegocio(dbReady = false,syncActive = true) {
...
export default useDepartamentoNegocio;
