/**
 * @package hooks/supervisor
 * @description Hook para manejar la sincronización de supervisor
 * @author CITEC
 */

const PACKAGE = 'hooks/supervisor';


import { useEffect, useState } from 'react';
import repository from '../../repositories/local/supervisor/repository';

// servicios
import syncService from '../../services/supervisor/syncService';


function useSupervisor(dbReady = false,syncActive = true) {
