/**
 * @package hooks/caso_visita
 * @description Hook para manejar la sincronización de caso_visita
 * @author CITEC
 */

const PACKAGE = 'hooks/caso_visita';


import { useEffect, useState } from 'react';
import repository from '../../repositories/local/caso_visita/repository';

// servicios
import syncService from '../../services/caso_visita/syncService';


function useCasoVisita(dbReady = false,syncActive = true) {
