/**
 * @package hooks/diagnostico_tipo
 * @description Hook para manejar la sincronización de diagnostico_tipo
 * @author CITEC
 */

const PACKAGE = 'hooks/diagnostico_tipo';


import { useEffect, useState } from 'react';
import repository from '../../repositories/local/diagnostico_tipo/repository';

// servicios
import syncService from '../../services/diagnostico_tipo/syncService';


function useDiagnosticoTipo(dbReady = false,syncActive = true) {
...
export default useDiagnosticoTipo;
