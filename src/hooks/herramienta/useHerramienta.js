/**
 * @package hooks/herramienta
 * @description Hook para manejar la sincronización de herramienta
 * @author CITEC
 */

const PACKAGE = 'hooks/herramienta';


import { useEffect, useState } from 'react';
import repository from '../../repositories/local/herramienta/repository';

// servicios
import syncService from '../../services/herramienta/syncService';


function useHerramienta(dbReady = false,syncActive = true) {
