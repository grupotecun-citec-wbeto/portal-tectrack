...
import repository from '../../repositories/local/linea/repository';

// servicios
import syncService from '../../services/linea/syncService';


function useLinea(dbReady = false,syncActive = true) {
