...
import repository from '../../repositories/local/division/repository';

// servicios
import syncService from '../../services/division/syncService';


function useDivision(dbReady = false,syncActive = true) {
