/**
 * @package hooks/estatus_maquinaria
 * @description Hook para manejar la sincronización de estatus_maquinaria
 * @author CITEC
 */

const PACKAGE = 'hooks/estatus_maquinaria';


import { useEffect, useState } from 'react';
import repository from '../../repositories/local/estatus_maquinaria/repository';

// servicios
import syncService from '../../services/estatus_maquinaria/syncService';


function useEstatusMaquinaria(dbReady = false,syncActive = true) {
...
export default useEstatusMaquinaria;
