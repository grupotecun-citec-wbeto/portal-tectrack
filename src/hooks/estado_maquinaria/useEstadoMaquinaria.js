/**
 * @package hooks/estado_maquinaria
 * @description Hook para manejar la sincronización de estado_maquinaria
 * @author CITEC
 */

const PACKAGE = 'hooks/estado_maquinaria';
...
// servicios
import syncService from '../../services/estado_maquinaria/syncService';


function useEstadoMaquinaria(dbReady = false,syncActive = true) {
...
export default useEstadoMaquinaria;
