...
import repository from '../../repositories/local/modelo/repository';

// servicios
import syncService from '../../services/modelo/syncService';


function useModelo(dbReady = false,syncActive = true) {
