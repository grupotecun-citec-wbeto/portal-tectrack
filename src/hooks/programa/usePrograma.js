/**
 * @package hooks/programa
 * @description Hook para manejar la sincronización de programa
 * @author CITEC
 */

const PACKAGE = 'hooks/programa';


import { useEffect, useState } from 'react';
import repository from '../../repositories/local/programa/repository';

// servicios
import syncService from '../../services/programa/syncService';


function usePrograma(dbReady = false,syncActive = true) {
