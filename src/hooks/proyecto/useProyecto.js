/**
 * @package proyecto
 * @description Hook para manejar la sincronización de proyectos
 * @author CITEC
 */
...
// servicios
import syncService from '../../services/proyecto/syncService';


function useProyecto(dbReady = false,syncActive = true) {
