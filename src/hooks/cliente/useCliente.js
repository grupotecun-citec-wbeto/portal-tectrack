/**
 * @package hooks/cliente
 * @description Hook para manejar la sincronización de cliente
 * @author CITEC
 */

const PACKAGE = 'hooks/cliente';


import { useEffect, useState } from 'react';
import repository from '../../repositories/local/cliente/repository';

// servicios
import syncService from '../../services/cliente/syncService';


function useCliente(dbReady = false,syncActive = true) {
