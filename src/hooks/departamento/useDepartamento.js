/**
 * @package hooks/departamento
 * @description Hook para manejar la sincronización de departamento
 * @author CITEC
 */

const PACKAGE = 'hooks/departamento';


import { useEffect, useState } from 'react';
import repository from '../../repositories/local/departamento/repository';

// servicios
import syncService from '../../services/departamento/syncService';


function useDepartamento(dbReady = false,syncActive = true) {
