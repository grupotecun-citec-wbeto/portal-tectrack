/**
 * @package hooks/unidad_negocio
 * @description Hook para manejar la sincronización de unidad_negocio
 * @author CITEC
 */

const PACKAGE = 'hooks/unidad_negocio';


import { useEffect, useState } from 'react';
import repository from '../../repositories/local/unidad_negocio/repository';

// servicios
import syncService from '../../services/unidad_negocio/syncService';


function useUnidadNegocio(dbReady = false,syncActive = true) {
...
export default useUnidadNegocio;
